...
localhost 代理提示。图文：<Forum URL>｜视频：<Bilibili URL>｜脚本：<GitHub URL>

## B 站动态

Windows 用户想上手 RuyiSDK，第一步先把 WSL 2 + Ubuntu 24.04 环境验收
清楚。本期包含自动预检脚本、真实版本证据和常见问题；不补造安装截图，遇到
localhost 代理警告也如实保留。视频：<Bilibili URL>｜配套仓库：<GitHub URL>

## 短文案

RuyiSDK Windows/WSL 教程 01：安装并验证 WSL 2 + Ubuntu 24.04。真实环境、
自动脚本、版本证据和代理提示一次讲清。图文 <Forum URL>｜视频 <Bilibili URL>
